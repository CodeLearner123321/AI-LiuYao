...
public class Prediction {
    ...
    public static class Description {
        @AIDocField(desc = "问题（根节点）", required = false)
        private String question;
        @AIDocField(desc = "问题的背景（根节点）", required = false)
    ...
    public static class Gua {
        @AIDocField(desc = "主卦,64卦中的某一卦,参照补充说明（根节点）", required = true)
        private String zhuGua;
        @AIDocField(desc = "变卦,64卦中的某一卦,参照补充说明,可能没有变卦（根节点）", required = false)
    ...
    public static class DatePart {
        ...
        @AIDocField(desc = "时间信息，比如：在年上就是2012、2045等表示年份的日期，在月上就是1、2、10、12等表示月份的信息，在日上就是1、12、60等表示日期的信息，在时上就是1、3、23、60等表示小时的信息（根节点）", required = false)
        private String time;
    }

    @Data
    public static class Ganzhi {
        @AIDocField(desc = "天干信息,在{甲,乙,丙,丁,戊,己,庚,辛,壬,癸}中取一个（根节点）", required = false)
        private String tiangan;
        @AIDocField(desc = "地支信息,在{子,丑,寅,卯,辰,巳,午,未,申,酉,戌,亥}中取一个（根节点）", required = false)
